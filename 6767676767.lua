--// Premium User //--
local user_premium__001 = game.Players.desirespeed --// Replace "User101" with your username (NOT DISPLAY) //--
...
user_premium__001.Chatted:connect(function(cht)
	if cht:match(":benx .") then
		if game.Players.LocalPlayer ~= user_premium__001 then
			wait(0) local A_1 = "I use 67 Cam!" local A_2 = "All" local Event = game:GetService("ReplicatedStorage").DefaultChatSystemChatEvents.SayMessageRequest Event:FireServer(A_1, A_2) 
